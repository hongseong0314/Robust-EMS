...
class DQN():
    ...
    def epoch(self, runing_bar):
        ...
        if self.epochs_completed > self.days and self.epochs_completed % 1000 == 0:
    ...
    def setp_run(self):
        ...
        while(True):
            ...
            # step
            new_state, reward = self.env.step(n_epi=self.epochs_completed, time=self.time, battery=battery, charge=action, 
